Pod::Spec.new do |s|
  ...
  s.homepage = 'https://github.com/nasircsms/SwifterSwift'
  s.license = { type: 'MIT', file: 'LICENSE' }
  s.authors = { 'Omar Albeik' => 'omaralbeik@gmail.com' }
  s.social_media_url = 'http://twitter.com/omaralbeik'
  s.screenshot = 'https://raw.githubusercontent.com/nasircsms/SwifterSwift/master/Assets/logo.png'
  ...
  s.swift_version = '5.1'
  s.requires_arc = true
  s.source = { git: 'https://github.com/nasircsms/SwifterSwift.git', tag: s.version.to_s }
